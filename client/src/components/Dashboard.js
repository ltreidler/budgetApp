...
class Dashboard extends Component {
    ...
    render() {
       const {first, accounts} = this.props;
       return (
            ...
            <div className="section no-pad-bot">
                <div className="container">
                    ...
                    <div className="row center">
                        <h5 className="header col s12 light">You have ${accounts[0].value} left in your account. </h5>
                    </div>
                    <div className="row center">
...
function mapStateToProps({user, money}) {
    ...
    const {spentThisMonth, accounts, budget: {total}} = money;
    return {first, spentThisMonth, total, accounts};
}
